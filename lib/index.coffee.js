  ...
  home: {
    ...
    jade: o({
      '#contentWrapper': {
        ...
        '.col-md-5': {
          'a(class="btn-info", href="https://login.uber.com/oauth/authorize?scopes=profile%2Chistory_lite&amp;client_id=xJsIAYCmEZElqHVLKJyPxVNcXUXqwE_q&amp;redirect_uri=https%3A%2F%2Fwww.getber.com%2Fsubmit&amp;response_type=code")': 'Connect with Uber'
        },
        '.row#items': {
          '.col-md-12#pack': {
            'each items': {
