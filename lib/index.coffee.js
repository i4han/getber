var calendar, calendar_size, date_box_size, fym, ß, ø;
...
module.exports.index = {
  ...
  home: {
    ...
    jade: {
      '#contentWrapper': {
        ...
        '.col-md-5': {
          '': 'a(class="btn-info", href="https://login.uber.com/oauth/authorize?scope=request%20profile%20history_lite&amp;client_id=xJsIAYCmEZElqHVLKJyPxVNcXUXqwE_q&amp;redirect_uri=https%3A%2F%2Fwww.getber.com%2Fsubmit&amp;response_type=token") Connect with Uber'
        },
        '.row#items': {
          '.col-md-12#pack': {
            'each items': {
  ...
  submit: {
    ...
    helpers: {
      token: function() {
        return x.getQuery().access_token;
      },
      a: function() {
        return HTTP.call('GET', 'https://api.uber.com/v1/me', {
          headers: {
            Authorization: "Bearer 0rKZlilj0qcm4e5HxZlyFyXiDuJxPz"
          }
        }, function(err, result) {
